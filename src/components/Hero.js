...
export const Hero = ()=>{
  return(
    <div className='h-screen flex items-center justify-center m-auto p-4 hero-section'>
      <div className="grid grid-cols-2 md:grid-cols-1 items-center w-customThree justify-items-center  gap-4">
        <div className="selection:bg-custom-color selection:text-white mx-auto xs:w-88">
          <h2 className='text-white text-4xl font'>Take your business</h2>
          <h1 className='text-white text-7xl tooling mt-2'>Above Expectations</h1>
